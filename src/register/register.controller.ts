...
@ApiTags('SNS인증 후 Monodg 회원정보저장 (회원정보, 토큰정보, 약관동의정보, 알림유무ster') 
@Controller('register')
export class RegisterController {
  ...
  @Post()
  create(@Body('user') createRegisterDto: CreateRegisterDto, @Body('token') scUserPushToken, @Body('agree') agree) {
